                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterion">
                                     ...
                                     <input type="text" v-model="buscar" @keyup.enter="listRol(1,buscar,criterion)" class="form-control" placeholder="Texto a buscar">
                                    <button type="submit" @click="listRol(1,buscar,criterion)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
...
<script>
    export default {
        ...
        methods : {
            listRol (page, buscar, criterion){
                let me=this;
                var url = '/rol?page=' + page + '&buscar='+ buscar + '&criterion='+ criterion;
