                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="phone_contact" class="form-control" placeholder="Telefono del Contacto">
    ...
    export default {
        ...
        methods : {
             listPerson (page,buscar,criterion){
                let me=this;
                var url= '/supplier?page=' + page + '&buscar='+ buscar + '&criterion='+ criterion;
                  ...
                  case "person":
                      {
                          switch(action){
                              case 'register':{
                                  this.modal = 1;
                                  this.tittlemodal = 'Registrar Proveedor';
                                  this.name='';
                                  this.type_document='INE';
                                  this.num_document='';
                                  this.address='';
                              ...
                              case 'update':{
                                  this.modal =1;
                                  this.tittlemodal = 'Actualizar Proveedor';
                                  this.typeAction = 2;
